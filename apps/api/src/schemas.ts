          ...
          devices: {
            ...
            items: {
              ...
              properties: {
                ...
                signalIdentityKey: { type: 'string' },
                prekeyBundleFormat: { type: 'string' },
...
export const deviceBundleBodySchema = {
  ...
  properties: {
    ...
    authIdentityKey: { type: 'string', minLength: 32 },
    signalIdentityKey: { type: 'string', minLength: 32 },
    prekeyBundleFormat: { type: 'string', enum: ['prototype-v1', 'signal-x3dh-v1'] },
