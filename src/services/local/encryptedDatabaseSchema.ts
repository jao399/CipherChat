...
export const ENCRYPTED_LOCAL_DATABASE_SCHEMA: EncryptedLocalTableDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      { name: 'id', type: 'text', primaryKey: true },
      { name: 'conversation_id', type: 'text' },
      { name: 'recipient_device_id', type: 'text' },
  ...
  },
  {
    ...
    columns: [
      { name: 'id', type: 'text', primaryKey: true },
      { name: 'envelope_id', type: 'text', unique: true },
      { name: 'conversation_id', type: 'text' },
  ...
  },
  {
    ...
    columns: [
      { name: 'id', type: 'text', primaryKey: true },
      { name: 'conversation_id', type: 'text' },
      { name: 'remote_device_id', type: 'text' },
  ...
  },
  {
    ...
    columns: [
      { name: 'id', type: 'text', primaryKey: true },
      { name: 'owner_account_id', type: 'text' },
      { name: 'object_ref', type: 'text' },
      { name: 'retention_state', type: 'text' },
      { name: 'payload_ciphertext', type: 'ciphertext' },
      ...TIMESTAMP_COLUMNS,
    ],
    indexes: [
