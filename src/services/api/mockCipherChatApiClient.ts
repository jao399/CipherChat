        ...
        devices: [
          {
            ...
            signalIdentityKey: record.identityKey,
            prekeyBundleFormat: 'prototype-v1',
  ...
  async getPublicDeviceBundle(input: { accountId: string; deviceId: string }): Promise<PublicDeviceBundleResponse> {
    ...
    if (bundle) {
      return {
        ...
        signalIdentityKey: bundle.signalIdentityKey ?? bundle.identityKey,
        prekeyBundleFormat: bundle.prekeyBundleFormat ?? 'prototype-v1',
    ...
    return {
      ...
      signalIdentityKey: 'ed25519-spki:mock-public-device-bundle-key-material',
      prekeyBundleFormat: 'prototype-v1',
      signedPrekey: 'mock-signed-prekey-material',
      signedPrekeySignature: 'mock-signed-prekey-signature-material',
      oneTimePrekeys: ['mock-one-time-prekey-material'],
