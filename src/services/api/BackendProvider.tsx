  ...
  const value = useMemo<BackendContextValue>(
    () => ({
      status: {
        ...
        signalAdapterInstalled: messageCryptoReadiness.signalAdapterInstalled,
        signalAdapterEligible: messageCryptoReadiness.signalAdapterEligible,
        signalAdapterSummary: messageCryptoReadiness.signalAdapterSummary,
