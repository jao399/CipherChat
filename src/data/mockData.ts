...
export const remoteIdentityTrust: RemoteIdentityTrustRecord[] = [
  {
    ...
    displayName: 'Eleanor',
    handle: '@eleanor.sec',
    accountId: 'account_eleanor_0001',
    deviceId: 'device_eleanor_0001',
    identityKey: 'ed25519-spki:mock-eleanor-identity-key-v2',
    trustState: 'changed',
  ...
  },
  {
    ...
    identityKey: 'ed25519-spki:mock-maya-identity-key-v1',
    trustState: 'trusted',
  ...
  },
  {
    ...
    displayName: 'Noah',
    handle: '@noah.private',
    accountId: 'account_noah_000001',
    deviceId: 'device_noah_000001',
    identityKey: 'ed25519-spki:mock-noah-identity-key-v1',
    trustState: 'trusted',
  ...
  },
  {
    ...
    displayName: 'Liam',
    handle: '@liam.keys',
    accountId: 'account_liam_000001',
    deviceId: 'device_liam_000001',
    identityKey: 'ed25519-spki:mock-liam-identity-key-v1',
    trustState: 'new',
  ...
  },
  {
    ...
    displayName: 'Zoe',
    handle: '@zoe.safe',
    accountId: 'account_zoe_000001',
    deviceId: 'device_zoe_000001',
    identityKey: 'ed25519-spki:mock-zoe-identity-key-v1',
    trustState: 'trusted',
  ...
  },
  {
    ...
    displayName: 'Olivia',
    handle: '@olivia.lock',
    accountId: 'account_olivia_0001',
    deviceId: 'device_olivia_0001',
    identityKey: 'ed25519-spki:mock-olivia-identity-key-v1',
    trustState: 'new',
